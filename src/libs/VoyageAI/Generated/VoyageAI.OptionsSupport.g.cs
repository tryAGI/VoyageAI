...
namespace VoyageAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::VoyageAI.AutoSDKRetryOptions Retry { get; set; } = new global::VoyageAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::VoyageAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::VoyageAI.IAutoSDKHook>();
        ...
        public global::VoyageAI.AutoSDKClientOptions AddHook(
            global::VoyageAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::VoyageAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::VoyageAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::VoyageAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::VoyageAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::VoyageAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::VoyageAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::VoyageAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::VoyageAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::VoyageAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::VoyageAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::VoyageAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::VoyageAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::VoyageAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::VoyageAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::VoyageAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::VoyageAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::VoyageAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::VoyageAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::VoyageAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::VoyageAI.AutoSDKClientOptions clientOptions,
            global::VoyageAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::VoyageAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::VoyageAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::VoyageAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::VoyageAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::VoyageAI.IAutoSDKHook, global::VoyageAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::VoyageAI.AutoSDKHookContext context)
        {
