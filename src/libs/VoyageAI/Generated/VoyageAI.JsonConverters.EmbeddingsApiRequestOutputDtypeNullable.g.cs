...
{
    /// <inheritdoc />
    public sealed class EmbeddingsApiRequestOutputDtypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::VoyageAI.EmbeddingsApiRequestOutputDtype?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::VoyageAI.EmbeddingsApiRequestOutputDtypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
