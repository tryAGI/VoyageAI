...
namespace VoyageAI
{
    public partial class VoyageAIClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::VoyageAI.RerankerApiResponse> RerankerApiAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::VoyageAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::VoyageAI.AutoSDKHttpResponse<global::VoyageAI.RerankerApiResponse>> RerankerApiAsResponseAsync(
                ...
                else
                {
                    await global::VoyageAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode >= 400 && (int)__response.StatusCode <= 499)
                            {
                                ...
                                global::VoyageAI.RerankerApiResponse2? __value_4XX = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_4XX = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_4XX = global::VoyageAI.RerankerApiResponse2.FromJson(__content_4XX, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_4XX = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::VoyageAI.RerankerApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::VoyageAI.AutoSDKHttpResponse<global::VoyageAI.RerankerApiResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::VoyageAI.RerankerApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::VoyageAI.RerankerApiResponse> RerankerApiAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::VoyageAI.RerankerApiRequest
            {
                Query = query,
                Documents = documents,
                Model = model,
