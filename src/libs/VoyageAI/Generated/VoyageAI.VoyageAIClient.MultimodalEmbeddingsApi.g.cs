...
namespace VoyageAI
{
    public partial class VoyageAIClient
    {
        ...
        private static readonly global::VoyageAI.EndPointSecurityRequirement s_MultimodalEmbeddingsApiSecurityRequirement0 =
        ...
        private static readonly global::VoyageAI.EndPointSecurityRequirement[] s_MultimodalEmbeddingsApiSecurityRequirements =
            new global::VoyageAI.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::VoyageAI.MultimodalEmbeddingsApiResponse> MultimodalEmbeddingsApiAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::VoyageAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::VoyageAI.AutoSDKHttpResponse<global::VoyageAI.MultimodalEmbeddingsApiResponse>> MultimodalEmbeddingsApiAsResponseAsync(
                ...
                else
                {
                    await global::VoyageAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode >= 400 && (int)__response.StatusCode <= 499)
                            {
                                ...
                                global::VoyageAI.MultimodalEmbeddingsApiResponse2? __value_4XX = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_4XX = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_4XX = global::VoyageAI.MultimodalEmbeddingsApiResponse2.FromJson(__content_4XX, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_4XX = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::VoyageAI.ApiException<global::VoyageAI.MultimodalEmbeddingsApiResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::VoyageAI.MultimodalEmbeddingsApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::VoyageAI.AutoSDKHttpResponse<global::VoyageAI.MultimodalEmbeddingsApiResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::VoyageAI.MultimodalEmbeddingsApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::VoyageAI.MultimodalEmbeddingsApiResponse> MultimodalEmbeddingsApiAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::VoyageAI.MultimodalEmbeddingsApiRequest
            {
                Inputs = inputs,
                Model = model,
                InputType = inputType,
