...
namespace VoyageAI.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "VoyageAI.CLI";
    private const string UserSecretApiKeyName = "VOYAGEAI_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"VOYAGEAI_API_KEY"];
    private const string CredentialFileDirectoryName = ".voyage-ai";

    public static async global::System.Threading.Tasks.Task<global::VoyageAI.VoyageAIClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::VoyageAI.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::VoyageAI.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::VoyageAI.VoyageAIClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::VoyageAI.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::VoyageAI.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::VoyageAI.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::VoyageAI.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("VOYAGEAI_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::VoyageAI.ApiException exception)
    {
        var builder = new StringBuilder();
