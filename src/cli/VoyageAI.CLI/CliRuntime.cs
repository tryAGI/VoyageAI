...
internal static class CliRuntime
{
    ...
    public static async Task<global::VoyageAI.VoyageAIClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::VoyageAI.ApiException exception)
    {
        var builder = new StringBuilder();
